  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="relative py-3 sm:max-w-xl sm:mx-auto ">
          <div className="relative px-4 py-10 bg-white dark:bg-gray-700 mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
            <div className="max-w-md mx-auto">
              <div className="flex items-center space-x-5">
                <div className="h-14 w-14 bg-yellow-200 rounded-full flex flex-shrink-0 justify-center items-center text-yellow-500 text-2xl font-mono">i</div>
                <div className="block pl-2 font-semibold text-xl self-start text-gray-700">
                  <h2 className="leading-relaxed dark:text-white text-black ">Create an Event</h2>
              ...
              <div className="divide-y divide-gray-200">
                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  <div className="flex flex-col">
                    <label className="leading-loose dark:text-white text-black">Event Title</label>
                  ...
                  <div className="flex flex-col">
                    <label className="leading-loose dark:text-white text-black">Event Subtitle</label>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="flex flex-col">
                      <label className="leading-loose dark:text-white text-black">Start</label>
                    ...
                    <div className="flex flex-col">
                      <label className="leading-loose  dark:text-white text-black">End</label>
                      <div className="relative focus-within:text-gray-600 text-gray-400">
                  ...
                  <div className="flex flex-col">
                    <label className="leading-loose  dark:text-white text-black">Event Description</label>
                    <input type="text" className="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Optional"/>
                  </div>
                </div>
